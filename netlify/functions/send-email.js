...
exports.handler = async (event) => {
  ...
  try {
    ...
    const html = `<div style="font-family:Arial,sans-serif;max-width:620px;margin:0 auto;color:#333;border-radius:10px;overflow:hidden;border:1px solid #e0e0e0">
      <div style="background:#021623;padding:28px 32px;text-align:center">
        <img src="https://nimmobilier59-afk.github.io/wp-content/uploads/2025/09/N20-Immobilier-.png" alt="N20 Immobilier" style="height:50px;display:block;margin:0 auto 14px">
        <p style="color:#6EC1E4;margin:0;font-size:13px;letter-spacing:2px;text-transform:uppercase">Nouveau Mandat de Recherche</p>
        <p style="color:rgba(255,255,255,0.4);margin:6px 0 0;font-size:12px">Réf. ${ref} — ${dt}</p>
      </div>
      <div style="padding:24px 32px;background:#f8f9fb">
        ${s('Demandeur')}
        ...
        ${d.coVisible ? s('Co-locataire') + `<table style="width:100%;border-collapse:collapse;font-size:13px">${r('Nom complet', `${d.coFirstName} ${d.coLastName}`, true)}${r('Date de naissance', d.coDob, false)}${r('Téléphone', d.coPhone, true)}${r('Email', d.coEmail, false)}</table>` : ''}
        ${s('Critères du bien')}
        <table style="width:100%;border-collapse:collapse;font-size:13px">
      ...
      <div style="background:#021623;padding:16px 32px;text-align:center">
        <p style="color:#6EC1E4;font-size:11px;margin:0">N20 Immobilier — contact@n20immobilier.ch — +41 76 419 20 21</p>
      </div>
    </div>`;
